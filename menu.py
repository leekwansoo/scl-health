...
subject_selected = st.sidebar.selectbox("Select Subject", ["Mathematics", "Science", "History", "Literature"], key="subject_select")
st.write(f"Selected Subject: {subject_selected}")
...
if uploaded_file:
    ...
    results = store_pdf_content(parsed_file)
    if results:
        st.sidebar.write("PDF content loaded successfully.")
